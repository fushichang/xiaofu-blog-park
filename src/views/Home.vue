    ...
    <el-container>
      <el-aside width="200px" class="home-aside">
        ...
        <div class="open-mouse">
          <el-button @click="openMouse" type="primary" plain size="mini"
            >发帖</el-button
          >
        </div>
        <div class="open-mouse">
          <el-button @click="saveAva" type="primary" plain size="mini"
            >更新头像</el-button
          >
        </div>
        <div class="login-out">
        ...
        <div class="main-body">
          ...
          >
            ...
            <el-table-column label="创建人">
              <template slot-scope="scope">
                <el-tag size="medium" v-if="isCurrentUser(scope.row)">{{
                  scope.row.creater
                }}</el-tag>
...
export default {
  ...
  methods: {
    ...
    saveAva() {
      ...
      let params = {
        user_id: id,
        avatar: 'http://60.205.246.126/images/2020/12/29/1609208447243503.jpg',
      }
      let res = UserHttp.updateinfo(params)
      let { code, msg } = res
